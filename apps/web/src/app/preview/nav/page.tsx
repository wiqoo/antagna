...
const OPTIONS = [
  ...
  {
    slug: 'dock-side',
    name: 'Side Dock · Customizable ✓',
    nameAr: 'دوك جانبي قابل للتخصيص',
    desc: 'نفس الـ dock بس على اليمين (RTL) على الديسكتوب، أسفل على الموبايل. المستخدم يخصّص الموقع/الحجم/العناصر.',
    pros: ['موحد بين الموبايل/ديسكتوب', 'قابل للتخصيص', 'badges + شيء جذاب'],
    cons: ['عناصر قليلة مرئية (5-7)', 'يحتاج إعدادات per-user'],
  },
];
